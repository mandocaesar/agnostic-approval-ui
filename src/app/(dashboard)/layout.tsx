          ...
          <aside className="hidden w-72 shrink-0 flex-col overflow-y-auto border-r border-slate-200/60 bg-gradient-to-b from-white via-[#f5f8fd] to-[#ecf2ff] px-6 py-8 text-slate-700 shadow-[8px_0_24px_-16px_rgba(15,23,42,0.24)] lg:flex">
            <div className="flex items-center justify-between gap-3 pb-6">
              ...
              {/* <button
                ...
                className="inline-flex items-center rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600 shadow-sm transition hover:bg-slate-100"
              >
                Hide
              </button> */}
            </div>
            ...
            <div className="mt-8 rounded-xl border border-slate-200 bg-white p-4 text-xs text-slate-500 shadow-sm">
              Dispatch faster decisions by curating rule playbooks and domain owners.
            </div>
          </aside>
        ) : null}
        {!isSidebarVisible ? (
          <button
            ...
            className="fixed left-4 top-4 z-40 hidden rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-wide text-slate-700 shadow-sm transition hover:bg-slate-100 lg:inline-flex"
          >
            Show menu
          </button>
        ) : null}
